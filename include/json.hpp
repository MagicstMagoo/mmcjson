...
namespace json 
{
    ...
    */
    ...
    MMCJSON_INLINE std::ostream& operator<<(std::ostream& out, const object& obj)
    {
        // TODO: format output
    ...
    // *      parser impl      *
    // *************************
    MMCJSON_INLINE std::optional<value> parser::parse(const std::string& content)
    {
        return parser(content.cbegin(), content.cend()).parse();
    }

    MMCJSON_INLINE std::optional<value> parser::parse()
    {
        if (!skip_whitespace()) {
            return std::nullopt;
        }
    ...
    MMCJSON_INLINE value parser::parse_value()
    {
        switch (*_cur) {
        case 'n':
            return parse_null();
    ...
    MMCJSON_INLINE value parser::parse_null()
    {
    ...
    MMCJSON_INLINE value parser::parse_boolean()
    {
    ...
    MMCJSON_INLINE value parser::parse_number()
    {
    ...
    MMCJSON_INLINE value parser::parse_string()
    {
    ...
    MMCJSON_INLINE value parser::parse_array()
    {
        if (*_cur == '[') {
            ++_cur;
        }
    ...
    MMCJSON_INLINE value parser::parse_object()
    {
        if (*_cur == '{') {
            ++_cur;
        }
    ...
    MMCJSON_INLINE std::optional<std::string> parser::parse_stdstring()
    {
        if (*_cur == '"') {
            ++_cur;
        }
    ...
    MMCJSON_INLINE bool parser::skip_whitespace() noexcept
    {
        while (_cur != _end) {
            switch (*_cur) {
            case ' ':
    ...
    MMCJSON_INLINE bool parser::skip_digit()
    {
        // At least one digit
    ...
    MMCJSON_INLINE std::optional<value> parse(const std::string& content)
    {
